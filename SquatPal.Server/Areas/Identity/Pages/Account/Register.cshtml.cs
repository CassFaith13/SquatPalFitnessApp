...
namespace SquatPal.Server.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                await _userStore.SetUserNameAsync(admin, Input.Email, CancellationToken.None);
                await _emailStore.SetEmailAsync(admin, Input.Email, CancellationToken.None);
                ...
                if (result.Succeeded)
                {
                    ...
                    var adminUserId = await _userManager.GetUserIdAsync(admin);
                    ...
                    var callbackUrl = Url.Page(
                        ...
                        pageHandler: null,
                        values: new { area = "Identity", userId = adminUserId, code = code, returnUrl = returnUrl },
